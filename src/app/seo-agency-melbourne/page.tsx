    ...
    <main className="min-h-screen bg-[#020816] text-white overflow-x-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-10 py-16 lg:py-24">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          <a
            href="#contact-cta"
            className="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl bg-[#FF1744] hover:bg-[#FF4D6D] transition-colors font-semibold text-white text-base"
          >
          ...
          <a
            href="tel:0490881483"
            className="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl glass border border-[#0066FF]/30 hover:border-[#0066FF]/60 text-white font-semibold text-base transition-all"
          >
