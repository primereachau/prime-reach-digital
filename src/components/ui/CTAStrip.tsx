      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          <div className="text-center md:text-left">
            <p className="text-[var(--text-muted)] text-sm uppercase tracking-widest font-medium mb-2">Ready to grow?</p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 flex-shrink-0">
            <a
              href="tel:0490881483"
              className="group flex items-center gap-3 glass border border-[var(--pr-blue)]/30 hover:border-[var(--pr-blue)]/60 px-6 py-3.5 rounded-xl transition-all duration-300"
            >
              <div className="w-8 h-8 rounded-lg bg-[var(--pr-blue)]/15 flex items-center justify-center group-hover:bg-[var(--pr-blue)]/25 transition-colors">
                <Phone size={15} className="text-[var(--pr-blue)]" />
              </div>
              <div>
                <div className="text-[var(--text-muted)] text-[10px] leading-none mb-0.5">Call us directly</div>
