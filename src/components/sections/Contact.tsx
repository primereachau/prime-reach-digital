  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full px-4 pt-5 pb-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white text-sm focus:outline-none focus:border-[var(--pr-blue)]/50 transition-all duration-200"
      />
      <label
        htmlFor={id}
        className={`absolute left-4 transition-all duration-200 pointer-events-none ${
          lifted
            ? "top-1.5 text-[10px] font-semibold text-[var(--pr-blue)] uppercase tracking-wider"
            : "top-1/2 -translate-y-1/2 text-sm text-[var(--text-dimmer)]"
        }`}
      >
        {label}{required && " *"}
      </label>
        ...
        <div className="grid lg:grid-cols-[360px_1fr] gap-12 lg:gap-16">
          ...
          >
            <div>
              <a
                href="tel:0490881483"
                className="flex items-center gap-4 glass border border-[var(--pr-blue)]/20 rounded-2xl px-5 py-4 mb-8 hover:border-[var(--pr-blue)]/40 transition-colors group"
              >
                <div className="w-12 h-12 rounded-xl bg-[var(--pr-blue)]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[var(--pr-blue)]/20 transition-colors">
                  <Phone size={20} className="text-[var(--pr-blue)]" />
                </div>
                <div>
                  <div className="text-[var(--text-muted)] text-xs mb-0.5">Prefer to call? Ring us directly</div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <CheckCircle2 size={16} className="text-[var(--pr-blue)] mt-0.5 flex-shrink-0" />
                    <span className="text-[var(--text-dim)] text-sm leading-relaxed">{item}</span>
                  </div>
                ))}
              </div>
            </div>
                ...
                return (
                  <div key={i} className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[var(--pr-blue)]/10 flex items-center justify-center flex-shrink-0">
                      <Icon size={16} className="text-[var(--pr-blue)]" />
                    </div>
                    <div>
                      <div className="text-[var(--text-dimmer)] text-xs">{d.label}</div>
          ...
          <motion.div
            ...
            className="bg-[var(--pr-navy)] border border-white/[0.08] rounded-2xl p-8 lg:p-10"
          >
            {submitted ? (
              <motion.div
              ...
              >
                <div className="w-16 h-16 rounded-full bg-[var(--pr-blue)]/10 flex items-center justify-center mb-5">
                  <CheckCircle2 size={32} className="text-[var(--pr-blue)]" />
                </div>
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="relative">
                  <select
                    ...
                    value={form.service}
                    onChange={onChange}
                    className="w-full px-4 py-3.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-white focus:outline-none focus:border-[var(--pr-blue)]/50 transition-colors appearance-none"
                  >
                    <option value="" className="bg-[var(--pr-navy)]">I&apos;m interested in...</option>
                    <option value="website" className="bg-[var(--pr-navy)]">Website Design & Management</option>
                    <option value="seo" className="bg-[var(--pr-navy)]">SEO</option>
                    <option value="google-ads" className="bg-[var(--pr-navy)]">Google Ads</option>
                    <option value="meta-ads" className="bg-[var(--pr-navy)]">Meta Ads (Facebook & Instagram)</option>
                    <option value="tiktok" className="bg-[var(--pr-navy)]">TikTok Ads</option>
                    <option value="social" className="bg-[var(--pr-navy)]">Social Media Management</option>
                    <option value="gbp" className="bg-[var(--pr-navy)]">Google Business Profile</option>
                    <option value="all" className="bg-[var(--pr-navy)]">Full Digital Package</option>
                  </select>
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-[var(--text-dimmer)]">▾</div>
                </div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full px-4 py-3.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white text-sm placeholder-[var(--text-faint)] focus:outline-none focus:border-[var(--pr-blue)]/50 transition-colors resize-none"
                  />
                </div>
                ...
                <MagneticButton data-cursor-cta={true} className="w-full">
                  ...
                  >
                    <span className="absolute inset-0 bg-[var(--pr-crimson)] transition-colors duration-300 group-hover:bg-[var(--pr-crimson-light)]" />
                    <span className="absolute inset-0 opacity-0 group-hover:opacity-60 blur-xl bg-[var(--pr-crimson)] transition-opacity duration-500" />
