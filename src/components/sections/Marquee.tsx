...
const items = [
  ...
  { Icon: Globe, label: "Web Design", color: "#0066FF" },
  { Icon: SiGoogle, label: "SEO", color: "#34A853" },
];
...
export default function Marquee() {
  return (
    <div className="relative py-6 border-y border-white/[0.06] overflow-hidden">
      {/* Edge fades */}
      <div className="absolute left-0 top-0 bottom-0 w-24 z-10 bg-gradient-to-r from-[#020816] to-transparent pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-24 z-10 bg-gradient-to-l from-[#020816] to-transparent pointer-events-none" />
        ...
        {doubled.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[#475569] text-sm font-medium tracking-wide">
                {item.label}
              </span>
            </div>
          );
